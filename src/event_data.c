...
void DisableNationalPokedex(void)
{
    ...
    gSaveBlock2Ptr->pokedex.nationalunlocked = 0;
    *nationalDexVar = 0;
...
{
    u16 *nationalDexVar = GetVarPointer(VAR_NATIONAL_DEX);
    gSaveBlock2Ptr->pokedex.nationalunlocked = 1;
...
{
    if (gSaveBlock2Ptr->pokedex.nationalunlocked > 0 && VarGet(VAR_NATIONAL_DEX) == 0x302 && FlagGet(FLAG_SYS_NATIONAL_DEX))
        return TRUE;
    else
        return FALSE;
}
