...
const u8 gText_ContinueMenuMap[] = _("Location:");
...
const u8 gText_EVO_FRIENDSHIP[]                     = _("Lv Up, high friendship");
const u8 gText_EVO_FRIENDSHIP_DAY[]                 = _("Lv Up, high friendship, day");
const u8 gText_EVO_FRIENDSHIP_NIGHT[]               = _("Lv Up, high friendship, night");
const u8 gText_EVO_LEVEL[]                          = _("Lv Up to {STR_VAR_2}");
...
const u8 gText_EVO_LEVEL_ATK_GT_DEF[]               = _("Lv Up to {STR_VAR_2}, Atk > Def");
const u8 gText_EVO_LEVEL_ATK_EQ_DEF[]               = _("Lv Up to {STR_VAR_2}, Atk = Def");
const u8 gText_EVO_LEVEL_ATK_LT_DEF[]               = _("Lv Up to {STR_VAR_2}, Atk < Def");
const u8 gText_EVO_LEVEL_SILCOON[]                  = _("Lv Up to {STR_VAR_2}, Silcoon persona");
const u8 gText_EVO_LEVEL_CASCOON[]                  = _("Lv Up to {STR_VAR_2}, Cascoon persona");
const u8 gText_EVO_LEVEL_NINJASK[]                  = _("Lv Up to {STR_VAR_2}");
const u8 gText_EVO_LEVEL_SHEDINJA[]                 = _("Lv Up to {STR_VAR_2}, party<6, 1x POKéBALL");
const u8 gText_EVO_BEAUTY[]                         = _("Lv Up, high beauty");
const u8 gText_EVO_LEVEL_FEMALE[]                   = _("Lv Up to {STR_VAR_2}, is female");
const u8 gText_EVO_LEVEL_MALE[]                     = _("Lv Up to {STR_VAR_2}, is male");
const u8 gText_EVO_LEVEL_NIGHT[]                    = _("Lv Up to {STR_VAR_2}, night");
const u8 gText_EVO_LEVEL_DAY[]                      = _("Lv Up to {STR_VAR_2}, day");
const u8 gText_EVO_LEVEL_DUSK[]                     = _("Lv Up to {STR_VAR_2}, dusk (5-6PM)");
const u8 gText_EVO_ITEM_HOLD_DAY[]                  = _("Lv Up, holds {STR_VAR_2}, day");
const u8 gText_EVO_ITEM_HOLD_NIGHT[]                = _("Lv Up, holds {STR_VAR_2}, night");
const u8 gText_EVO_ITEM_HOLD[]                      = _("Lv Up holding a {STR_VAR_2}");
const u8 gText_EVO_MOVE[]                           = _("Lv Up, knows {STR_VAR_2}");
const u8 gText_EVO_MOVE_TYPE[]                      = _("Lv Up, knows {STR_VAR_2} move");
const u8 gText_EVO_SPECIFIC_MAPSEC[]                         = _("Lv Up on {STR_VAR_2}");
const u8 gText_EVO_ITEM_MALE[]                      = _("{STR_VAR_2} used on male");
const u8 gText_EVO_ITEM_FEMALE[]                    = _("{STR_VAR_2} used on female");
const u8 gText_EVO_LEVEL_RAIN[]                     = _("Lv Up to {STR_VAR_2} while raining");
const u8 gText_EVO_SPECIFIC_MON_IN_PARTY[]          = _("Lv Up with {STR_VAR_2} in party");
const u8 gText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[]   = _("Lv Up with dark type in party");
const u8 gText_EVO_TRADE_SPECIFIC_MON[]             = _("Traded for {STR_VAR_2}");
const u8 gText_EVO_SPECIFIC_MAP[]                   = _("Lv Up on {STR_VAR_2}");
